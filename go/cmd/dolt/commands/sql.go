...
func newDatabase(name string, dEnv *env.DoltEnv) dsqle.Database {
	return dsqle.NewDatabase(name, dEnv.DoltDB, dEnv.RepoStateReader(), dEnv.GetRepoStateWriter())
}

func newBatchedDatabase(name string, dEnv *env.DoltEnv) dsqle.Database {
	return dsqle.NewBatchedDatabase(name, dEnv.DoltDB, dEnv.RepoStateReader(), dEnv.GetRepoStateWriter())
}
